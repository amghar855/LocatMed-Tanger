...
export function ChatbotClient({ initialMessage, initialSuggestions, patient }: ChatbotClientProps) {
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-slate-50">
      {/* ── Header ── */}
      <header className="relative z-[1000] flex h-14 shrink-0 items-center justify-between border-b border-slate-200/80 bg-white/95 px-4 backdrop-blur-sm">
        {/* Left — App Logo */}
        <Link
          href="/patient/dashboard"
          className="flex items-center gap-2 shrink-0 group w-[100px]"
        >
          ...
          <span className="font-bold text-base text-slate-900 group-hover:text-teal-600 transition-colors hidden sm:block">
            LOCATOMED
          </span>
        </Link>
        ...
        <div className="flex w-28 justify-end shrink-0">
            ...
            <SheetContent side="left" className="w-72 px-5 py-6">
              ...
              <div className="flex h-full flex-col">
                ...
                <div className="flex-1 overflow-y-auto">
                  ...
                  <PatientNavLinks onNavigate={() => setMenuOpen(false)} />
                </div>
      ...
      {/* ── Disclaimer ── */}
      <div className="flex shrink-0 items-start gap-2.5 border-b border-amber-100 bg-amber-50 px-4 py-3">
