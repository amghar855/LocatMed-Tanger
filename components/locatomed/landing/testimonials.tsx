...
const TESTIMONIALS = [
  {
    ...
    initials: "FB",
    quote:
      "Grâce à LocatMed, je ne rate plus jamais mon médicament du matin. L'application me rappelle tout et j'ai mes rendez-vous en un clic. C'est vraiment pratique !",
