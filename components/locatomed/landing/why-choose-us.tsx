...
const REASONS = [
  ...
  },
  {
    ...
    description:
      "Vos données médicales sont chiffrées et protégées. LocatMed ne vend jamais vos informations.",
    color: "text-teal-500",
    bg: "bg-teal-50",
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="lg:sticky lg:top-24 space-y-6">
            <div className="inline-flex items-center gap-2 bg-teal-50 border border-teal-200 rounded-full px-4 py-1.5">
              <span className="text-sm font-medium text-teal-700">Pourquoi LocatMed ?</span>
            </div>
            ...
            <p className="text-lg text-gray-500 leading-relaxed">
              Nous avons construit LocatMed parce que gérer sa santé ne devrait
